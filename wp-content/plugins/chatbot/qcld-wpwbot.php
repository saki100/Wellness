...
define('QCLD_wpCHATBOT_VERSION', '4.6.0');
...
<div class="wrap swpm-admin-menu-wrap">
    ...
    <div class="container wppt-settings-section" style="margin-right:unset;margin-left:unset; display:block; margin-top:40px" id="general_wp_nutshell">
        ...
        <h2 style="margin-top: 10px;color:#222"><?php echo esc_html__('WPBot – In a Nutshell', 'wpbot'); ?></h2>
        <h6 style="color:#222"><?php echo esc_html__('This is by no means a comprehensive list of WPBot features. But knowing these core terms will help you understand how WPBot was designed to work.', 'wpbot'); ?></h6>
    ...
    <div class="container wppt-settings-section" style="margin-right:unset;margin-left:unset;margin-top:40px;display:none" id="general_int">
        ...
        <h2 style="margin-top: 10px;color:#222"><?php echo esc_html__('WPBot Interactions', 'wpbot'); ?></h2>
        <h3 style="color:#222"><?php echo esc_html__('You can create user interactions in the following ways:', 'wpbot'); ?></h3>
            <div class="panel panel-default">
